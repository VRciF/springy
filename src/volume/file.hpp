    ...
    namespace Volume{
        class File : public Springy::Volume::IVolume{
            ...
            public:
                ...
                virtual int stat(boost::filesystem::path v_file_name, struct ::stat *buf);
                virtual int fstat(boost::filesystem::path v_file_name, int fd, struct ::stat *buf);

                virtual int statvfs(boost::filesystem::path v_path, struct ::statvfs *stat);

                virtual int fchown(boost::filesystem::path v_file_name, int fd, uid_t owner, gid_t group);
                ...
                virtual int ftruncate(boost::filesystem::path v_file_name, int fd, off_t length);
